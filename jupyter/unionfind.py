...
def persistence(f):
    ...
    for v, i, j in fi:
        ...
        if lefb and rigb and ~topb and ~botb:
            ...
            elif (lefp != rigp) and (rigp != topp) and (topp != botp) and (botp != lefp) and (lefp != topp) and (rigp == botp):
                d,ki,kj = min((lefd['max'], lefd['elderi'], lefd['elderj']), (rigd['max'],rigd['elderi'],rigd['elderj']))
                pairs.append((d-v, (i,j), (ki,kj)))
            ...
            elif (lefp != rigp) and (rigp != topp) and (topp != botp) and (botp != lefp) and (lefb == topp) and (rigp != botp):
                d,ki,kj = min((lefd['max'], lefd['elderi'], lefd['elderj']), (rigd['max'],rigd['elderi'],rigd['elderj']))
                pairs.append((d-v, (i,j), (ki,kj)))
